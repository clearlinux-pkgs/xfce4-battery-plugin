...
Source0  : https://archive.xfce.org/src/panel-plugins/xfce4-battery-plugin/1.1/xfce4-battery-plugin-1.1.6.tar.bz2
...
%prep
%setup -q -n xfce4-battery-plugin-1.1.6
cd %{_builddir}/xfce4-battery-plugin-1.1.6
pushd ..
cp -a xfce4-battery-plugin-1.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735071164
