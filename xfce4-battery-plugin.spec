...
Source0  : https://archive.xfce.org/src/panel-plugins/xfce4-battery-plugin/1.1/xfce4-battery-plugin-1.1.4.tar.bz2
...
%prep
%setup -q -n xfce4-battery-plugin-1.1.4
cd %{_builddir}/xfce4-battery-plugin-1.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616610069
...
cp %{_builddir}/xfce4-battery-plugin-1.1.4/COPYING %{buildroot}/usr/share/package-licenses/xfce4-battery-plugin/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/xfce4-battery-plugin-1.1.4/COPYING.LIB %{buildroot}/usr/share/package-licenses/xfce4-battery-plugin/83ba6546e00f890f3a26a9bedd264084f8527d5e
%make_install
